...
export default class CnbcNewsEnterpreneur extends Component {
  constructor(props) {
    super(props);
    this.state = {
      news: [],
  ...
  componentDidMount() {
    axios
      .get(`${API_ENDPOINT.NEWS.CNBC.ENTREPRENEUR}`)
      ...
      <section className="idn-container">
        <Container>
          <div className="idn-items-list">
            ...
            <ProgramSectionTitle title="CNBC INDONESIA -  BERITA ENTERPRENUER" />
