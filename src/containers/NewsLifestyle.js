...
export default class NewsLifestyle extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>Indonesia Berita - Informasi berita kesehatan</title>
          <meta
            property="og:description"
            content="Indeks berita kesehatan terbaru hari ini dari peristiwa, kecelakaan, kriminal, hukum, berita unik, Politik, dan liputan khusus di Indonesia dan Internasional"
          />
