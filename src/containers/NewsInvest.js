...
export default class NewsInvest extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>Indonesia Berita - Informasi berita investasi</title>
          <meta
            property="og:description"
            content="Indeks berita investasi terbaru hari ini dari peristiwa, kecelakaan, kriminal, hukum, berita unik, Politik, dan liputan khusus di Indonesia dan Internasional"
          />
