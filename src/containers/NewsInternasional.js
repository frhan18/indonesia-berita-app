...
export default class NewsInternasional extends Component {
  constructor(props) {
    super(props);
    this.state = {
      news: [],
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>Indonesia Berita - Informasi berita internasional</title>
          <meta
            property="og:description"
            content="Indeks berita internasional terbaru hari ini dari peristiwa, kecelakaan, kriminal, hukum, berita unik, Politik."
          />
