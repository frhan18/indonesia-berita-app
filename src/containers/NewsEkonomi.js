...
export default class NewsEkonomi extends Component {
  ...
  async receivedData() {
    try {
      const response = await axios.get(`${API_ENDPOINT.NEWS.EKONOMI}`, {
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>Indonesia Berita - Informasi berita ekonomi</title>
          <meta
            property="og:description"
            content="Indeks berita ekonomi terbaru hari ini dari peristiwa, kecelakaan, kriminal, hukum, berita unik, Politik, dan liputan khusus di Indonesia dan Internasional"
          />
