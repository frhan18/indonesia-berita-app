...
export default class NewsSports extends Component {
  ...
  async receivedData() {
    try {
      const response = await axios.get(`${API_ENDPOINT.NEWS.OLAHRAGA}`, {
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>Indonesia Berita - Informasi berita olahraga</title>
          <meta
            property="og:description"
            content="Indeks berita olahraga terbaru hari ini dari peristiwa, kecelakaan, kriminal, hukum, berita unik, Politik, dan liputan khusus di Indonesia dan Internasional"
          />
